...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<Widget> returnExercisesButton() {
    return [
      ElevatedButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => new Exercicio1()),
          );
        },
      ),
      ElevatedButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => new Exercicio2()),
          );
        },
      ),
      ElevatedButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => new Exercicio3()),
          );
        },
      )
    ];
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
            ...
            children: returnExercisesButton()),
...
class Exercicio2 extends StatefulWidget {
  Exercicio2({Key? key}) : super(key: key);
